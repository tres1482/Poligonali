...
export default function Home() {
    ...
    async function creatingGame(gameId, bidAmount, playWhite) {
            if(window.ethereum) {
                ...
                const createGame = await chessContract.createGame(gameId, ethers.utils.parseEther(bidAmount.toString()), playWhite, {value: ethers.utils.parseEther(bidAmount.toString())});
